...
public class MCreatorDustsmeltergui extends Elementsvariety.ModElement {
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorDustSmelter.TileEntityCustom)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("variety:textures/dustsmeltergui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Dust Smelter", 7, 2, -10066330);
		}
