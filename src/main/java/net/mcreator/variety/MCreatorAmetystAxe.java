...
public class MCreatorAmetystAxe extends Elementsvariety.ModElement {
	@GameRegistry.ObjectHolder("variety:ametystaxe")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("ametystaxe").setRegistryName("ametystaxe").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("variety:ametystaxe", "inventory"));
	}
