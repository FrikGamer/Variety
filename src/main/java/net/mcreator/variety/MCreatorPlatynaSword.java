...
public class MCreatorPlatynaSword extends Elementsvariety.ModElement {
	@GameRegistry.ObjectHolder("variety:platynasword")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("platynasword").setRegistryName("platynasword").setCreativeTab(CreativeTabs.COMBAT));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("variety:platynasword", "inventory"));
	}
}
