...
public class MCreatorNickelAxe extends Elementsvariety.ModElement {
	@GameRegistry.ObjectHolder("variety:nickelaxe")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("nickelaxe").setRegistryName("nickelaxe").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("variety:nickelaxe", "inventory"));
	}
