...
public class MCreatorPlatynaAxe extends Elementsvariety.ModElement {
	@GameRegistry.ObjectHolder("variety:platynaaxe")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("platynaaxe").setRegistryName("platynaaxe").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("variety:platynaaxe", "inventory"));
	}
