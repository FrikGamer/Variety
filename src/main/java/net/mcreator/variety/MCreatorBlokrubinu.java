...
public class MCreatorBlokrubinu extends Elementsvariety.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "variety:tileentityrudarubinu");
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(MCreatorRubin.block, (int) (1)));
		}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.rudarubinu";
		}
