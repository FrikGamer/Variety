...
public class MCreatorBlokrubinu1 extends Elementsvariety.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "variety:tileentityblokrubinu1");
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.blokrubinu1";
		}
