...
public class MCreatorSkplecakgui extends Elementsvariety.ModElement {
	public static int GUIID = 2;
	public static HashMap guiinventory = new HashMap();
	public static IInventory slots;

	public MCreatorSkplecakgui(Elementsvariety instance) {
		super(instance, 141);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.addSlotToContainer(new Slot(slots, 0, 8, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 1, 26, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 2, 44, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 3, 62, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 4, 80, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 5, 98, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 6, 116, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 7, 134, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 8, 152, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 9, 8, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 10, 26, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 11, 44, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 12, 62, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 13, 80, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 14, 98, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 15, 116, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 16, 134, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 17, 152, 48) {
			});
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("variety:textures/skplecakgui.png");
