...
public class MCreatorZeplecakgui extends Elementsvariety.ModElement {
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.addSlotToContainer(new Slot(slots, 0, 8, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 1, 26, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 3, 62, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 4, 80, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 5, 98, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 6, 116, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 7, 134, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 8, 152, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 9, 8, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 10, 26, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 11, 44, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 12, 62, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 13, 80, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 14, 98, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 15, 116, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 16, 134, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 17, 152, 30) {
			});
			this.addSlotToContainer(new Slot(slots, 18, 8, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 2, 44, 12) {
			});
			this.addSlotToContainer(new Slot(slots, 19, 26, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 20, 44, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 21, 62, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 22, 80, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 23, 98, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 24, 116, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 25, 134, 48) {
			});
			this.addSlotToContainer(new Slot(slots, 26, 152, 48) {
			});
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("variety:textures/zeplecakgui.png");
